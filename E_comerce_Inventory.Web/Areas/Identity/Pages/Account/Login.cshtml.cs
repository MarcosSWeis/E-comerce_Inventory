    ...
    public class LoginModel :PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                IdentityUser user = await _userManager.FindByEmailAsync(Input.Email);//poner dentro de un try catch
                ...
                {
                    ModelState.AddModelError("Credential","Credenciales no validas, el email o la contraseña son incorrectas");
                }
            }
